...
inject_fragment(
  template_path = "paneles_template_t.html",
  fragment_path = "fragments/update_date.html",
  placeholder = "<!-- inject:update_date -->",
  output_path = "../paneles_globales_t.html"
)

inject_fragment(
  template_path = "../paneles_globales_t.html", #A PARTIR DEL SEGUNDO LLAMADO YA TIENE LOS PLACEHOLDERS ASI QUE PARA NO SOBREESCRIBIR LOS QUE ESTAN REEMPLAZADOS, SE LLAMA AL TEMPLATE FINAL.
  fragment_path = "../datatable_panel_vt.html",
...
inject_fragment(
  template_path = "../paneles_globales_t.html",
