...
archivos_a_borrar <- c(
  file.path(destino, "global_trimestral" , "correr_y_actualizar.lnk"),
  file.path(destino, "global_trimestral" , "templates", "Paneles_globales.R"),
  file.path(destino, "global_trimestral" , "templates", "salidas.r"),
  file.path(destino, "global_trimestral" , "templates", "injects.r"),
  file.path(destino, "global_trimestral" , "templates", "subir_paneles.R")
)
