...
inject_fragment(
  ...
  output_path = "../paneles_ICA-SFE.html"
)

inject_fragment(
  template_path = "../paneles_ICA-SFE.html", #A PARTIR DEL SEGUNDO LLAMADO YA TIENE LOS PLACEHOLDERS ASI QUE PARA NO SOBREESCRIBIR LOS QUE ESTAN REEMPLAZADOS, SE LLAMA AL TEMPLATE FINAL.
...
inject_fragment(
  template_path = "../paneles_ICA-SFE.html",
