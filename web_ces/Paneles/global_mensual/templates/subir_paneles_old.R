...
archivos_a_borrar <- c(
  base::file.path(destino, "global_mensual" , "correr_y_actualizar.lnk"),
  base::file.path(destino, "global_mensual" , "templates", "Paneles_globales.R"),
  base::file.path(destino, "global_mensual" , "templates", "salidas.r"),
  base::file.path(destino, "global_mensual" , "templates", "injects.r"),
  base::file.path(destino, "global_mensual" , "templates", "subir_paneles.R"),
  base::file.path(destino, "global_mensual" , "input")
)
...
for (archivo in archivos_a_borrar) {
  if (base::dir.exists(archivo) || base::file.exists(archivo)) {
