...
inject_fragment(
  template_path = "paneles_template_m.html",
  fragment_path = "fragments/update_date.html",
  placeholder = "<!-- inject:update_date -->",
  output_path = "../paneles_globales_m.html"
)

inject_fragment(
  template_path = "../paneles_globales_m.html", #A PARTIR DEL SEGUNDO LLAMADO YA TIENE LOS PLACEHOLDERS ASI QUE PARA NO SOBREESCRIBIR LOS QUE ESTAN REEMPLAZADOS, SE LLAMA AL TEMPLATE FINAL.
...
inject_fragment(
  template_path = "../paneles_globales_m.html",
