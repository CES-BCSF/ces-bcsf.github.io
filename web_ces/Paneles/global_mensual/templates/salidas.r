...
nombres <- base::as.character(readxl::read_excel("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel global mensual//Archivos necesarios/DF_paneles.xlsx", # NOMBRES DE LA SERIE
                                                 sheet = "mensuales",
                                                 range = "a1:cd1", col_names = F)) # AL CARGAR UNA NUEVA SERIE, SE DEBE MODIFICAR EL RANGO PARA INCLURLA

# CARGAR Y PREPARAR LOS DATOS
base <- readxl::read_excel("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel global mensual/Archivos necesarios/DF_paneles.xlsx", # 
                           sheet = "mensuales",
                           range = "a362:cd433", col_names = F) # 362 ES ENERO DE 2020 | AL CARGAR UNA NUEVA SERIE, SE DEBE MODIFICAR EL RANGO PARA INCLURLA
base::names(base) <- nombres

media <- readxl::read_excel("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel global mensual/Archivos necesarios/DF_paneles.xlsx", # CALCULO DE MEDIA
...
desvio <- readxl::read_excel("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel global mensual/Archivos necesarios/DF_paneles.xlsx", # CALCULO DE SD
                             sheet = "mensuales", col_names = T) |>
  dplyr::select(-Fecha) |>                
...
htmlwidgets::saveWidget(
  ...
  libdir = "templates/fragments/var_mensuales/datatable_panel_files",
...
htmlwidgets::saveWidget(
  ...
  libdir = "templates/fragments/var_ia/datatable_panel_files_ia",
  selfcontained = FALSE,    # <---- IMPORTANTE PARA QUE NO ROMPA EL LAYOUT
  title = NULL
)
