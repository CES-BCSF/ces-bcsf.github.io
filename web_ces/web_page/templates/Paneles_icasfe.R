...
clasif <- readxl::read_excel("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel ICA-SFE/Archivos necesarios/Clasificador.xlsx",
                     sheet = "Clasificador",
                     col_names = T)
...
# ORDEN DE LAS COLUMNAS
  ...
  writexl::write_xlsx(
    ...
    path = "C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel ICA-SFE//Archivos necesarios/DF_paneles.xlsx"
  )

  #
  
### EJECUTANDORMD RMD PARA HTML DE VARIACIONES MENSUALES ####
...
# rmarkdown::render("C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel ICA-SFE/Panel_VM_48_html.Rmd",
#                   output_file = "C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel ICA-SFE/Htmls/Panel_ICA-SFE-VM.html",
#                   output_dir = "C:/mysyncfolders/bcsf.com.ar/BCSF - Grupo CES - Documentos/CicSFE_sp/_Reportes rmd/Panel ICA-SFE/Htmls/")
